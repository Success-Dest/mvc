                ...
                <div class="rental-card" 
                    ...
                    <div class="rental-info">
                            ...
                            <?php foreach(array_slice($rental->features, 0, 2) as $feature): ?>
                                <span class="feature-tag">
                                    ...
                                    switch(strtolower(str_replace(' ', '-', $feature))) {
                                        case 'home-delivery': $icon = '🚚'; break;
                                        case 'quality-guarantee': $icon = '✅'; break;
                                        case 'online-booking': $icon = '💻'; break;
                                        case 'expert-advice': $icon = '👨‍🏫'; break;
                                        case 'equipment-maintenance': $icon = '🔧'; break;
                                        case 'bulk-discounts': $icon = '💰'; break;
                                        case 'team-packages': $icon = '👥'; break;
                                        case 'size-fitting': $icon = '📏'; break;
                                        default: $icon = '✓'; break;
                                    }
                                    echo $icon . ' ' . $feature;
                                    ?>
                        ...
                        <div class="contact-actions">
                            ...
                            <button class="btn-whatsapp" onclick="whatsappStore('<?php echo $rental->whatsapp; ?>')">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M17.472,14.382c-0.297-0.149-1.758-0.867-2.03-0.967c-0.273-0.099-0.471-0.148-0.670,0.15c-0.197,0.297-0.767,0.966-0.940,1.164c-0.173,0.199-0.347,0.223-0.644,0.075c-0.297-0.15-1.255-0.463-2.39-1.475c-0.883-0.788-1.48-1.761-1.653-2.059c-0.173-0.297-0.018-0.458,0.13-0.606c0.134-0.133,0.298-0.347,0.446-0.52C9.890,9.97,9.939,9.846,10.037,9.647c0.099-0.198,0.05-0.371-0.025-0.52C9.963,8.979,9.367,7.518,9.123,6.725c-0.237-0.771-0.479-0.667-0.648-0.679c-0.168-0.012-0.359-0.014-0.55-0.014c-0.191,0-0.501,0.072-0.763,0.359C6.920,6.688,6.156,7.406,6.156,8.867c0,1.461,1.090,2.873,1.241,3.072c0.149,0.198,2.132,3.255,5.166,4.564c0.722,0.311,1.286,0.497,1.725,0.636c0.724,0.230,1.384,0.198,1.905,0.120c0.581-0.087,1.758-0.719,2.006-1.413c0.248-0.694,0.248-1.289,0.173-1.413C18.098,14.651,17.769,14.531,17.472,14.382z"/>
                                    <path d="M12.057,2C6.513,2,2.01,6.503,2.01,12.047c0,1.777,0.457,3.456,1.258,4.926L2,22l5.169-1.356c1.426,0.781,3.040,1.193,4.888,1.193c5.544,0,10.047-4.503,10.047-10.047C22.104,6.503,17.601,2,12.057,2z"/>
                                </svg>
                                WhatsApp
                            </button>
